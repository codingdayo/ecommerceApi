...
import codingdayo.com.Ecommerce.exceptions.InvalidCredentialsException;
...
import codingdayo.com.Ecommerce.security.JwtUtils;
...
public class UserServiceImpl implements UserService {
    ...
    public Response loginUser(LoginRequest loginRequest) {
        User user = userRepo.findByEmail(loginRequest.getEmail()).orElseThrow(() -> new NotFoundException("User Does not exist"));
