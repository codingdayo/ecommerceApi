...
public class OrderItemController {
    ...
    public ResponseEntity<Response> placeOrder(@PathVariable Long orderItemId, @RequestParam String status){
        return ResponseEntity.ok(orderItemService.updateOderItemStatus(orderItemId, status));
    }
